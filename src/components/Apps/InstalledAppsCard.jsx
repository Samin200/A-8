  ...
  return (
    <div className="text-[#001931] items-center bg-white p-[16px] flex justify-between rounded-[16px] max-sm:flex-col max-sm:gap-[16px] max-sm:justify-center">
      ...
      <div className="flex flex-col items-center sm:items-start justify-center">
        <div className="text-[20px] font-medium max-sm:text-center">
            {app.title}
        </div>
        <div className="flex items-center text-[16px]">
          ...
          <div className=" px-[10px] py-[7.5px] rounded-[5px]">
            {app.ratingAvg}
          </div>
        </div>
      </div>
    ...
    <div>
        <button className=" text-white text-[16px] font-semibold bg-[#00D390] py-[12px] px-[16px] rounded-[5px] ">Uninstall</button>
    </div>
    </div>
  );
};
